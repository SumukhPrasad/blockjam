...
ActiveRecord::Schema[7.0].define(version: 2023_10_19_120253) do
  ...
  create_table "heats", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["level_id"], name: "index_heats_on_level_id"
    t.index ["slug"], name: "uniq_slug_per_heat", unique: true
  end
  ...
  create_table "levels", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["contest_id"], name: "index_levels_on_contest_id"
  end
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.binary "preseed", limit: 10485760
    t.binary "seed", limit: 10485760
    t.binary "postseed", limit: 10485760
    t.text "description"
